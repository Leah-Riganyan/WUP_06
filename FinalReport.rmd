...
When we looked at all data, everything ended up different. The fisherXY test tells us that between each race is a statistical difference enough to be significant.
